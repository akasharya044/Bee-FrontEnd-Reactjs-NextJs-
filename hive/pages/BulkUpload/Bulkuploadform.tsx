...
import { Box, Tab, Tabs, Typography, Grid, Breadcrumbs } from '@mui/material';
...
const Bulkuploadform = () => {
  ...
  const handleFieldChangebyprojectname = (event: any) => {
    ...
    if (name === 'projectName') {
        if (value === '' || alphanumericWithSpaceRegex.test(value)) {
            ...
            // Set error message if the input doesn't match the regular expression
            setProjectNameError('Only alphanumeric characters and spaces are allowed');
        }
    } else {
  ...
  return (
    <MainLayout>
      <>
        <MainHeader pageTitle={'Bulk Request Creation'}>
          <Breadcrumbs aria-label="breadcrumb" className="text-dark breadcrumb-text">
            ...
            <Typography color="text.primary">Bulk</Typography>
          </Breadcrumbs>
        </MainHeader>
        ...
        <Box className="header-bg  page-padding-container">
          <Tabs
            ...
            className='dashtab-parent' sx={{maxWidth: '380px'}}
          >
            <Tab
        ...
        <Box component="div" className="main-box page-padding-container">
          ...
          {value === 0 && (
            <>
              ...
              <Grid
                ...
                rowSpacing={3}
                columnSpacing={2}
                sx={{ marginTop: '1px !important', paddingBottom: '50px' }}
              >
