...
interface Product {
  ...
  description: string;
  quantity: string;
  productasociatedGroupId: string;
}
...
if (result && !result.success) {
  ...
  const isFormValid = () => {
    if (
      ...
      formData.quantity && 
      formData.productasociatedGroupId
  ...
  const handleProductSelect = (selectedProduct: Product | null) => {
    ...
    if (selectedProduct) {
      ...
      setFormData((prevData: any) => ({
        ...
        category: selectedProduct.category ,
        description2: selectedProduct.description , 
        productasociatedGroupId: selectedProduct.productasociatedGroupId
...
console.log('Validation passed, proceeding with API call.');
    ...
    const postData = {
      ...
      associatedProducts: [
        {
          associatedProduct: {
            id: formData.productasociatedGroupId,
            name: formData.name2,
          },
